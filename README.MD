...
[![Single inference Result UI (click to expand)](docs/images/single_inference_ui_thumb.png)](docs/images/result_singleInference.png)
...
* Consider adding a short GIF for day‑to‑day operations in `docs/`.
